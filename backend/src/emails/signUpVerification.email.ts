...
const signUpEmail = (emailDetails: signUpEmailDto): any => {
  ...
  <![endif]-->
                                                    ...
                                                    <td style="padding:0px;margin:0px;border-spacing:0;">
                                                      ...
                                                      <table class="wrapper" role="module" data-type="image" border="0"
                                                        ...
                                                        <tbody>
                                                          <tr>
                                                            <center>
                                                              <h1>GameZ Verification Email</h1>
                                                            </center>
                                                          </tr>
                                                        </tbody>
                                                      </table>
                                                              ...
                                                              <div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span style="font-size: 18px"> </span><span
                                                                    ...
                                                                    Please verify your email address to start writting
                                                                    now</span><span style="font-size: 18px">.</span>
                                                                </div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span
                                                                ...
                                                                <tbody>
                                                                  <tr>
                                                                    <td align="center" bgcolor="#ffbe00"
                                                                      ...
                                                                      <a href="http://localhost:8080/verify/${token}"
                              ...
                              <div data-role="module-unsubscribe" class="module" role="module" data-type="unsubscribe"
                                ...
                                <div class="Unsubscribe--addressLine">
                                  <p class="Unsubscribe--senderName" style="font-size:12px; line-height:20px;">GameZ
                                    News</p>
                                  <p style="font-size:12px; line-height:20px;"><span
                                      class="Unsubscribe--senderAddress">nguyenquanglam3008@gmail.com</span>, <span
                                      class="Unsubscribe--senderCity">Ho Chi Minh</span>, <span
                                      class="Unsubscribe--senderZip">70000</span></p>
                                </div>
