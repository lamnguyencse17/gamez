...
export default function LatestItem(props) {
  return (
    <div className="w-full h-32 lg:flex">
      ...
      />
      <div
        className="flex flex-col justify-between leading-normal bg-white border-b-2 border-l-2 border-r-2 border-gray-400 rounded-b lg:w-4/5 py-auto lg:border-l-0 lg:border-t lg:border-gray-400 lg:rounded-b-none lg:rounded-r">
